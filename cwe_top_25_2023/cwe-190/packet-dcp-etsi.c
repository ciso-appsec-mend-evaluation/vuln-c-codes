...
The file is extracted from the NIST database https://samate.nist.gov/SARD/test-cases/501160/versions/1.0.0
The below code snippet contains not only the CWE-190 but also contains CWE-122, CWE-680 and CWE-131.
