/*
This file is extracted from the NIST database https://samate.nist.gov/SARD/test-cases/148910/versions/1.0.0
The code had CVE https://nvd.nist.gov/vuln/detail/CVE-2013-2484 which came from the wireshark application.
